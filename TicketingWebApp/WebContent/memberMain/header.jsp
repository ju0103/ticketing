...
<body>
			...
			<div class="container">
				...
				<div class="collapse navbar-collapse" id="navbarContent">
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						...
						<li class="nav-item"><a class="nav-link" href="../service/serviceMain.jsp">고객센터</a></li>
					</ul>
				</div>
			</div>
		</nav>
	...
	%>
		<nav class="navbar navbar-expand-lg navbar-dark bg-dark">
			<div class="container">
				<a class="ticketing" href="../memberMain/index.jsp">TICKETING</a>
				<button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarContent" aria-controls="navbarContent" aria-expanded="false" aria-label="Toggle navigation">
					<span class="navbar-toggler-icon"></span>
				</button>
					...
					<ul class="navbar-nav ms-auto mb-2 mb-lg-0">
						...
						<div class="nav-item btn-group dropdown">
							...
							<ul class="dropdown-menu" aria-labelledby="navbarDropdown" data-bs-popper="none">
								<li><a class="dropdown-item" href="../member/memberReservationForm.jsp">나의 예매</a></li>
								<li><a class="dropdown-item" href="#">나의 문의</a></li>
								<li><hr class="dropdown-divider"></li>
								<li><a class="dropdown-item" href="../member/memberUpdateForm.jsp">회원 정보 수정</a></li>
								<li><a class="dropdown-item" href="../member/memberDeleteForm.jsp">탈퇴하기</a></li>
							</ul>						
						</div>
						<li class="nav-item"><a class="nav-link" href="../service/serviceMain.jsp">고객센터</a></li>
					</ul>
