...
CREATE UNIQUE INDEX ticketing.review_pk ON
    ticketing.review (
        r_id
    ASC )
        TABLESPACE users PCTFREE 10
...
ALTER TABLE ticketing.review
    ADD CONSTRAINT review_pk PRIMARY KEY ( r_id )
        USING INDEX ticketing.review_pk;
