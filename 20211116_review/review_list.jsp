...
<body>
	<center>
		...
		<table width="600">
			<tr>
				<td align="right">
					<a href="../review/review_writeForm.jsp?p_code=<%=p_code %>&pageNum=<%=pageNum %>">글 쓰 기</a>
				</td>
			</tr>
		</table>
		<table width="800">
			<tr height="60" style="border-bottom: 2px solid #000; font-weight: bold">
			...
			%>
			<tr height="50" style="border-bottom: 1px solid #eee;">
				<td>
				<%
					if(r_fsize >0){
				%>
				...
				<!-- 탭 내용 -->
					<div id="show<%= i %>" style="display: none;">
						...
						<div style="margin-left: 380; margin-top: 30; margin-bottom: 30;">
							<input type="button" value="수정" class="btn btn-primary btn-sm" onclick="location.href='../review/review_edit.jsp?p_code=<%=p_code %>&r_id=<%=r_id %>'">&nbsp;&nbsp;&nbsp;&nbsp;
							<input type="button" value="삭제" class="btn btn-primary btn-sm" onclick="location.href='../review/review_delete.jsp?p_code=<%=p_code %>&r_id=<%=r_id %>'">
						</div>
					</div>
				</td>
				<!-- 탭 내용 -->
